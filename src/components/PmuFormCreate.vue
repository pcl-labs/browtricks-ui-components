        ...
        <div class="relative rounded-lg shadow-3 bg-white border border-grey-300 space-y-3 p-4 lg:py-6 lg:px-8 hidden">
         ...
         <div class="absolute right-0 -top-16 -translate-y-2 xs:translate-y-0 xs:top-0 rounded-lg shadow-3 bg-white border border-grey-300 xs:-right-16 inline-flex">      
              <div class="p-1.5 flex xs:flex-col gap-2 ">
                ...
                <Button class="text-grey-700 hover:bg-red/10 px-2 flex items-center justify-end" :btn-no-border="true" :btn-primary="false">
      ...
      <SlideOvers :open-dialog="isUploadDocument" dialog-title="Upload Document" @closeModal="isUploadDocument = false">
        ...
        <div class="flex flex-wrap justify-between items-strech mt-4">
          ...
          <Button @click="deleteCustomerDailog = true" :btn-no-border="true" :btn-primary="false"
            class="text-red hover:bg-red/10 xs:px-4 gap-x-2 inline-flex items-center hidden">
